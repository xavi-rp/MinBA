...
To solve these problems, the idea behind *MinBAR* is to sequentially fit several concentric SDMs, each with an increased diameter, from the centre of the species geographical distribution to the periphery, until a satisfactory model is reached. We call "buffers" to these concentric SDMs.
...
All the R scripts used in these case studies can be found at https://github.com/xavi-rp/MinBA. While *MinBAR* v.1.1.0 can be downloaded from CRAN at https://CRAN.R-project.org/package=MinBAR. The latest (unstable) version including a vignette is available at https://github.com/xavi-rp/MinBAR.
