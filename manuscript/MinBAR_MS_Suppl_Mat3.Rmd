...
This is the Supplementary Material to the article “Determining the minimal background area for MaxEnt species distribution models: MinBAR package” (https://CRAN.R-project.org/package=MinBAR) `r #, published as a pre-print in BioRxiv with the DOI: `
